...
# Run smc++ estimate
smc++ estimate 2.69e-8 -o /scratch/edegreef/whales/BOW_smcpp/smc_out_timepoints/1group/run_${SLURM_ARRAY_TASK_ID}/ --regularization-penalty 4.0 --nonseg-cutoff 100000 --thinning 2000 --cores 4 --timepoints 10 10000 /scratch/edegreef/whales/BOW_smcpp/masked_data_run_1group/ALL.*